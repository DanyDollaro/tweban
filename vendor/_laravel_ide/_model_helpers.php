...
namespace App\Models {
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Visita>|Visita newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<Visita>|Visita newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<Visita>|Visita query()
     * @method static mixed select($columns)
     * @method static mixed selectSub($query, $as)
     * @method static mixed selectRaw($expression, array $bindings)
     * @method static mixed fromSub($query, $as)
     ...
     * @mixin \Illuminate\Database\Query\Builder
     */
    class Visita extends \Illuminate\Database\Eloquent\Model
    {
        //
    }
